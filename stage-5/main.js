...
var $author$project$Gaming$toY = function (keyboard) {
...
var $author$project$Gaming$GotViewport = function (a) {
	return {$: 'GotViewport', a: a};
};
var $author$project$Gaming$VisibilityChanged = function (a) {
...
var $author$project$Gaming$KeyChanged = F2(
	function (a, b) {
		return {$: 'KeyChanged', a: a, b: b};
	});
var $author$project$Gaming$MouseButton = function (a) {
	return {$: 'MouseButton', a: a};
};
var $author$project$Gaming$MouseClick = {$: 'MouseClick'};
var $author$project$Gaming$MouseMove = F2(
	function (a, b) {
		return {$: 'MouseMove', a: a, b: b};
	});
var $author$project$Gaming$Resized = F2(
	function (a, b) {
		return {$: 'Resized', a: a, b: b};
	});
var $author$project$Gaming$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Gaming$gameSubscriptions = $elm$core$Platform$Sub$batch(
	_List_fromArray(
		[
			$elm$browser$Browser$Events$onResize($author$project$Gaming$Resized),
			$elm$browser$Browser$Events$onKeyUp(
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Gaming$KeyChanged(false),
				A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))),
			$elm$browser$Browser$Events$onKeyDown(
			A2(
				$elm$json$Json$Decode$map,
				$author$project$Gaming$KeyChanged(true),
				A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))),
			$elm$browser$Browser$Events$onAnimationFrame($author$project$Gaming$Tick),
			$elm$browser$Browser$Events$onVisibilityChange($author$project$Gaming$VisibilityChanged),
			$elm$browser$Browser$Events$onClick(
			$elm$json$Json$Decode$succeed($author$project$Gaming$MouseClick)),
			$elm$browser$Browser$Events$onMouseDown(
			$elm$json$Json$Decode$succeed(
				$author$project$Gaming$MouseButton(true))),
			$elm$browser$Browser$Events$onMouseUp(
			$elm$json$Json$Decode$succeed(
				$author$project$Gaming$MouseButton(false))),
			$elm$browser$Browser$Events$onMouseMove(
			A3(
				$elm$json$Json$Decode$map2,
				$author$project$Gaming$MouseMove,
				A2($elm$json$Json$Decode$field, 'pageX', $elm$json$Json$Decode$float),
				A2($elm$json$Json$Decode$field, 'pageY', $elm$json$Json$Decode$float)))
		]));
var $author$project$Gaming$Mouse = F4(
	function (x, y, down, click) {
		return {click: click, down: down, x: x, y: y};
	});
var $author$project$Gaming$Time = function (a) {
	return {$: 'Time', a: a};
};
...
var $author$project$Gaming$emptyKeyboard = {backspace: false, down: false, enter: false, keys: $elm$core$Set$empty, left: false, right: false, shift: false, space: false, up: false};
var $author$project$Gaming$mouseClick = F2(
	function (bool, mouse) {
		return _Utils_update(
			mouse,
			{click: bool});
	});
var $author$project$Gaming$mouseDown = F2(
	function (bool, mouse) {
		return _Utils_update(
			mouse,
			{down: bool});
	});
var $author$project$Gaming$mouseMove = F3(
	function (x, y, mouse) {
		return _Utils_update(
			mouse,
			{x: x, y: y});
	});
var $author$project$Gaming$toFixedScreen = F2(
	function (width, height) {
		return {bottom: -300, height: 600, left: -400, right: 400, top: 300, width: 800};
	});
...
var $author$project$Gaming$updateKeyboard = F3(
...
var $author$project$Gaming$gameUpdate = F3(
	function (updateMemory, msg, _v0) {
		...
		switch (msg.$) {
			case 'Tick':
				var time = msg.a;
				return A3(
					$author$project$Gaming$Game,
					vis,
					A2(updateMemory, computer, memory),
					computer.mouse.click ? _Utils_update(
						computer,
						{
							mouse: A2($author$project$Gaming$mouseClick, false, computer.mouse),
							time: $author$project$Gaming$Time(time)
						}) : _Utils_update(
						computer,
						{
							time: $author$project$Gaming$Time(time)
			...
			case 'GotViewport':
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							screen: A2($author$project$Gaming$toFixedScreen, viewport.width, viewport.height)
						}));
			case 'Resized':
				var w = msg.a;
				var h = msg.b;
				return A3(
					...
					_Utils_update(
						computer,
						{
							screen: A2($author$project$Gaming$toFixedScreen, w, h)
						}));
			case 'KeyChanged':
				var isDown = msg.a;
				var key = msg.b;
				return A3(
					...
					_Utils_update(
						computer,
						{
							keyboard: A3($author$project$Gaming$updateKeyboard, isDown, key, computer.keyboard)
						}));
			case 'MouseMove':
				var pageX = msg.a;
				var pageY = msg.b;
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							mouse: A3($author$project$Gaming$mouseMove, x, y, computer.mouse)
						}));
			case 'MouseClick':
				return A3(
					$author$project$Gaming$Game,
					...
					_Utils_update(
						computer,
						{
							mouse: A2($author$project$Gaming$mouseClick, true, computer.mouse)
						}));
			case 'MouseButton':
				var isDown = msg.a;
				return A3(
					...
					_Utils_update(
						computer,
						{
							mouse: A2($author$project$Gaming$mouseDown, isDown, computer.mouse)
						}));
			default:
				...
				return A3(
					...
					_Utils_update(
						computer,
						{
							keyboard: $author$project$Gaming$emptyKeyboard,
							mouse: A4($author$project$Gaming$Mouse, computer.mouse.x, computer.mouse.y, false, false)
						}));
		}
	});
var $elm$browser$Browser$Dom$getViewport = _Browser_withWindow(_Browser_getViewport);
var $author$project$Gaming$initialComputer = {
	keyboard: $author$project$Gaming$emptyKeyboard,
	mouse: A4($author$project$Gaming$Mouse, 0, 0, false, false),
	screen: A2($author$project$Gaming$toFixedScreen, 800, 600),
	time: $author$project$Gaming$Time(
...
var $author$project$Gaming$renderAlpha = function (alpha) {
...
var $author$project$Gaming$renderColor = function (color) {
	if (color.$ === 'Hex') {
		var str = color.a;
		return str;
	} else {
...
var $author$project$Gaming$renderTransform = F4(
	function (x, y, a, s) {
...
var $author$project$Gaming$renderCircle = F7(
			...
			A2(
				...
				A2(
					...
					$elm$svg$Svg$Attributes$fill(
						$author$project$Gaming$renderColor(color)),
					A2(
						$elm$core$List$cons,
						$elm$svg$Svg$Attributes$transform(
							A4($author$project$Gaming$renderTransform, x, y, angle, s)),
						$author$project$Gaming$renderAlpha(alpha)))),
			_List_Nil);
	});
var $elm$svg$Svg$image = $elm$svg$Svg$trustedNode('image');
var $author$project$Gaming$renderRectTransform = F6(
	function (width, height, x, y, angle, s) {
		return A4($author$project$Gaming$renderTransform, x, y, angle, s) + (' translate(' + ($elm$core$String$fromFloat((-width) / 2) + (',' + ($elm$core$String$fromFloat((-height) / 2) + ')'))));
	});
...
var $author$project$Gaming$renderImage = F8(
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$List$cons,
							$elm$svg$Svg$Attributes$transform(
								A6($author$project$Gaming$renderRectTransform, w, h, x, y, angle, s)),
							$author$project$Gaming$renderAlpha(alpha))))),
			_List_Nil);
	});
...
var $author$project$Gaming$toNgonPoints = F4(
...
var $author$project$Gaming$renderNgon = F8(
		...
		return A2(
			...
			A2(
				...
				$elm$svg$Svg$Attributes$points(
					A4($author$project$Gaming$toNgonPoints, 0, n, radius, '')),
				A2(
					$elm$core$List$cons,
					$elm$svg$Svg$Attributes$fill(
						$author$project$Gaming$renderColor(color)),
...
var $author$project$Gaming$renderOval = F8(
...
var $author$project$Gaming$addPoint = F2(
	function (_v0, str) {
		var x = _v0.a;
		var y = _v0.b;
		return str + ($elm$core$String$fromFloat(x) + (',' + ($elm$core$String$fromFloat(-y) + ' ')));
	});
var $author$project$Gaming$renderPolygon = F7(
	function (color, coordinates, x, y, angle, s, alpha) {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$elm$svg$Svg$Attributes$points(
					A3($elm$core$List$foldl, $author$project$Gaming$addPoint, '', coordinates)),
				A2(
					$elm$core$List$cons,
					$elm$svg$Svg$Attributes$fill(
						$author$project$Gaming$renderColor(color)),
...
var $author$project$Gaming$renderRectangle = F8(
...
var $author$project$Gaming$renderWords = F7(
...
var $author$project$Gaming$renderShape = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	var angle = _v0.c;
	var s = _v0.d;
	...
	switch (form.$) {
		case 'Circle':
			var color = form.a;
			var radius = form.b;
			return A7($author$project$Gaming$renderCircle, color, radius, x, y, angle, s, alpha);
		case 'Oval':
			var color = form.a;
			var width = form.b;
			var height = form.c;
			return A8($author$project$Gaming$renderOval, color, width, height, x, y, angle, s, alpha);
		case 'Rectangle':
			var color = form.a;
			var width = form.b;
			var height = form.c;
			return A8($author$project$Gaming$renderRectangle, color, width, height, x, y, angle, s, alpha);
		case 'Ngon':
			var color = form.a;
			var n = form.b;
			var radius = form.c;
			return A8($author$project$Gaming$renderNgon, color, n, radius, x, y, angle, s, alpha);
		case 'Polygon':
			var color = form.a;
			var points = form.b;
			return A7($author$project$Gaming$renderPolygon, color, points, x, y, angle, s, alpha);
		case 'Image':
			var width = form.a;
			var height = form.b;
			var src = form.c;
			return A8($author$project$Gaming$renderImage, width, height, src, x, y, angle, s, alpha);
		case 'Words':
			var color = form.a;
			var string = form.b;
			return A7($author$project$Gaming$renderWords, color, string, x, y, angle, s, alpha);
		default:
			var shapes = form.a;
			return A2(
				$elm$svg$Svg$g,
				A2(
					...
					$elm$svg$Svg$Attributes$transform(
						A4($author$project$Gaming$renderTransform, x, y, angle, s)),
					$author$project$Gaming$renderAlpha(alpha)),
				A2($elm$core$List$map, $author$project$Gaming$renderShape, shapes));
	}
};
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
var $author$project$Gaming$render = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$width('800px'),
					$elm$svg$Svg$Attributes$height('600px')
				]),
			A2($elm$core$List$map, $author$project$Gaming$renderShape, shapes));
	});
var $author$project$Gaming$videogame = F3(
	function (viewMemory, updateMemory, initialMemory) {
		var view = function (_v3) {
			var memory = _v3.b;
			var computer = _v3.c;
			return A2(
				$author$project$Gaming$render,
				computer.screen,
		...
		var update = F2(
			function (msg, model) {
				return _Utils_Tuple2(
					A3($author$project$Gaming$gameUpdate, updateMemory, msg, model),
					$elm$core$Platform$Cmd$none);
			});
		var subscriptions = function (_v2) {
			var visibility = _v2.a;
			if (visibility.$ === 'Hidden') {
				return $elm$browser$Browser$Events$onVisibilityChange($author$project$Gaming$VisibilityChanged);
			} else {
				return $author$project$Gaming$gameSubscriptions;
			}
		};
		var init = function (_v0) {
			return _Utils_Tuple2(
				A3($author$project$Gaming$Game, $elm$browser$Browser$Events$Visible, initialMemory, $author$project$Gaming$initialComputer),
				A2($elm$core$Task$perform, $author$project$Gaming$GotViewport, $elm$browser$Browser$Dom$getViewport));
		};
		return $elm$browser$Browser$element(
			{init: init, subscriptions: subscriptions, update: update, view: view});
	});
var $author$project$Gaming$Hex = function (a) {
	return {$: 'Hex', a: a};
};
...
var $author$project$Gaming$rectangle = F3(
	function (color, width, height) {
		return A6(
			...
			1,
			1,
			A3($author$project$Gaming$Rectangle, color, width, height));
	});
var $author$project$Gaming$Rgb = F3(
	function (a, b, c) {
		return {$: 'Rgb', a: a, b: b, c: c};
	});
var $elm$core$Basics$round = _Basics_round;
var $author$project$Gaming$colorClamp = function (number) {
	return A3(
...
var $author$project$Gaming$rgb = F3(
	function (r, g, b) {
		return A3(
			$author$project$Gaming$Rgb,
			$author$project$Gaming$colorClamp(r),
